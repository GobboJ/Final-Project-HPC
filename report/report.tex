...
We organized the implementations of the clustering algorithm into two different classes, namely the
\texttt{SequentialClustering} class, defined in the \texttt{SequentialClustering.h} header file, and the \texttt{ParallelClustering} class, defined in the\\\texttt{ParallelClustering.h} header file, which
implement the sequential and parallel implementations of the clustering algorithm respectively.

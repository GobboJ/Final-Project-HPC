...
public:
    ...
    std::pair<std::string, typename std::array<double, ND>::const_iterator> arrayIterator;

    std::pair<std::string, std::vector<double>> vector;
    std::pair<std::string, std::vector<double>::const_iterator> vectorIterator;

    std::pair<std::string, std::list<double>> list;
    std::pair<std::string, std::list<double>::const_iterator> listIterator;

    std::pair<std::string, std::deque<double>> deque;
    std::pair<std::string, std::deque<double>::const_iterator> dequeIterator;
